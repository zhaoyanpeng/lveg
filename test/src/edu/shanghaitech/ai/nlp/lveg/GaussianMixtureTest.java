...
//	@Test
	...
	public void testMultiply() {
		GaussianMixture gm0 = new GaussianMixture(LVeGLearner.ncomponent);
		GaussianMixture gm1 = new GaussianMixture(LVeGLearner.ncomponent);
		GaussianMixture gm2 = new GaussianMixture(LVeGLearner.ncomponent);
