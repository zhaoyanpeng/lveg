...
//	static {
	// circle -3-5-7-
	GrammarRule r0 = new UnaryGrammarRule((short) 1, (short) 0, RuleType.LRURULE);
	GrammarRule r1 = new UnaryGrammarRule((short) 3, (short) 0, RuleType.LRURULE);
	GrammarRule r2 = new UnaryGrammarRule((short) 2, (short) 1, RuleType.LRURULE);
	GrammarRule r3 = new UnaryGrammarRule((short) 4, (short) 1, RuleType.LRURULE);
	GrammarRule r4 = new UnaryGrammarRule((short) 8, (short) 2, RuleType.LRURULE);
	UnaryGrammarRule r5 = new UnaryGrammarRule((short) 9, (short) 2, RuleType.LRURULE);
	UnaryGrammarRule r6 = new UnaryGrammarRule((short) 5, (short) 3, RuleType.LRURULE);
	UnaryGrammarRule r7 = new UnaryGrammarRule((short) 8, (short) 3, RuleType.LRURULE);
	UnaryGrammarRule r8 = new UnaryGrammarRule((short) 9, (short) 3, RuleType.LRURULE);
	UnaryGrammarRule r9 = new UnaryGrammarRule((short) 6, (short) 4, RuleType.LRURULE);
	UnaryGrammarRule r10 = new UnaryGrammarRule((short) 9, (short) 4, RuleType.LRURULE);
	UnaryGrammarRule r11 = new UnaryGrammarRule((short) 7, (short) 5, RuleType.LRURULE);
	UnaryGrammarRule r12 = new UnaryGrammarRule((short) 8, (short) 6, RuleType.LRURULE);
	UnaryGrammarRule r13 = new UnaryGrammarRule((short) 3, (short) 7, RuleType.LRURULE);
	UnaryGrammarRule r14 = new UnaryGrammarRule((short) 8, (short) 7, RuleType.LRURULE);
	UnaryGrammarRule r15 = new UnaryGrammarRule((short) 9, (short) 8, RuleType.LRURULE);
	UnaryGrammarRule r25 = new UnaryGrammarRule((short) 9, (short) 8, RuleType.LRURULE);
...
//	}
	...
	public void testLVeGGrammar() {
		...
		*/
		...
		Debugger.checkUnaryRuleCircle(grammar, null, true);
	}
}
