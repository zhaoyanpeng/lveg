...
*/		
		...
		MaxRuleParser mrParser = new MaxRuleParser(grammar, lexicon);
...
*/		
	...
	public static double calculateLL(LVeGGrammar grammar, LVeGLexicon lexicon, StateTreeList stateTreeList, int maxLength) {
		int nUnparsable = 0;
		double ll = 0, sumll = 0;
